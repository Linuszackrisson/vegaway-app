			...
			<div className="homepage wrapper">
				...
				<div className="home-page__slider">
					{featuredProducts.length > 0 && (
						<ProductSlider title="New Releases" items={featuredProducts} pageType="home" />
					)}
				</div>
...
/* Uppdaterad: Jacob
 *
 * Responsiv styling och finslipning.
 * pagetype: "home" för att visa "New Releases"-produkter.
 */
