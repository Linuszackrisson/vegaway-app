...
const OrderConfirmationPage: React.FC = () => {
	...
	const updateOrderField = useCurrentOrderStore(state => state.updateOrderField);
	...
	return (
		<div className="order-confirmation wrapper px-1">
			<img src={Star} className="star-illustration" alt="Vegaway star illustration" />
			<section className="order-confirmation__content">
				{currentOrder ? (
					<>
						<h1 className="order-confirmation__message order-confirmation__message-1">Thank you for your order</h1>
						<h2 className="order-confirmation__message order-confirmation__message-2">
							{orderConfirmed ? "Your order has been confirmed!" : "Waiting for confirmation ..."}
						</h2>
					</>
				) : (
