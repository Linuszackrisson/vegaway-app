		...
		<div className="contact-page wrapper">
			<div className="contact-page-hero">
				<div className="contact-page-title-container">
					...
					<p className="contact-page__description first-paragraph-about">
						Vegaway was born one late night in Malmö when Jacob, a passionate vegetarian, stared at his empty fridge. He
						dreamed of a service that could deliver fresh, plant-based options straight to his door—a perfect blend of
						convenience and sustainability.
					</p>
					<p className="contact-page__description second-paragraph-about-2">
						With the help of his friends Isak, a tech expert, and Linus, a culinary creator, Jacob launched Vegaway in
						2020. Starting with bike deliveries in Malmö, the company quickly gained popularity for its high-quality,
			...
			<div className="contact-container-page px-1">
				...
				<p className="contact-page__description first-paragraph-ourvision-1">
					Our vision is to revolutionize food delivery by making plant-based options the natural first choice. We
					believe in a future where sustainable eating is not just a trend, but a way of life.
				</p>
				<p className="contact-page__description second-paragraph-ourvision-2">
					By 2025, we aim to operate entirely on renewable energy, use only eco-friendly packaging, and expand our
					service to all major Nordic cities while maintaining our commitment to local partnerships and zero food waste.
				</p>
				<section className="contact">
					<h2 className="contact-page__title contact-page__title-contact">Contact us</h2>
